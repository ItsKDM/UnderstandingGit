...
const baseURL = 'https://crudcrud.com/api/8337d4c8373c4f2989256f0d3d45c329/todoapp';
...
function appendTaskToList(task, list) {
    ...
    doneBtn.addEventListener('click', async () => {
        await moveTodoItem(task._id, task.name, task.description);
        list.removeChild(li);
    });
    ...
    deleteBtn.addEventListener('click', async () => {
        await deleteTodoItem(task._id, li);
        list.removeChild(li);
    });
